...
export const chinaRegions = [
  ...
  ["重庆市", ["重庆市","万州区","涪陵区","渝中区","大渡口区","江北区","沙坪坝区","九龙坡区","南岸区","北碚区","綦江区","大足区","渝北区","巴南区","黔江区","长寿区","江津区","合川区","永川区","南川区","璧山区","铜梁区","潼南区","荣昌区","开州区","梁平区","武隆区"],
             ["重庆县","城口县","丰都县","垫江县","忠县","云阳县","奉节县","巫山县","巫溪县","石柱土家族自治县","秀山土家族苗族自治县","酉阳土家族苗族自治县","彭水苗族土家族自治县"]],
  // ===== 华北 =====
  ["河北省",["石家庄市","长安区","桥西区","新华区","井陉矿区","裕华区","藁城区","鹿泉区","栾城区","井陉县","正定县","行唐县","灵寿县","高邑县","深泽县","赞皇县","无极县","平山县","元氏县","赵县","晋州市","新乐市"],
  ...
  ["黑龙江省",["哈尔滨市","道里区","南岗区","道外区","平房区","松北区","香坊区","呼兰区","阿城区","双城区","依兰县","方正县","宾县","巴彦县","木兰县","通河县","延寿县","尚志市","五常市"],
  ...
  ["宁夏回族自治区",["银川市","兴庆区","西夏区","金凤区","灵武市","永宁县","贺兰县"],
                    ["石嘴山市","大武口区","惠农区","平罗县"],
  ...
  ["澳门特别行政区",["澳门半岛","花地玛堂区","圣安多尼堂区","大堂区","望德堂区","风顺堂区"],
                     ["离岛","嘉模堂区","圣方济各堂区","路氹填海区"]],
  ["台湾省",["台北市","中正区","大同区","中山区","松山区","大安区","万华区","信义区","士林区","北投区","内湖区","南港区","文山区"],
            ["高雄市","楠梓区","左营区","鼓山区","三民区","盐埕区","前金区","新兴区","苓雅区","前镇区","旗津区","小港区"],
            ["新北市","板桥区","新庄区","中和区","永和区","土城区","树林区","三峡区","莺歌区","三重区","芦洲区","五股区","泰山区","林口区","淡水区","汐止区","瑞芳区","新店区","深坑区","石碇区","坪林区","乌来区"],
            ["桃园市","桃园区","中坜区","平镇区","八德区","杨梅区","芦竹区","大溪区","龙潭区","龟山区","大园区","观音区","新屋区","复兴区"],
            ["台中市","中区","东区","南区","西区","北区","北屯区","西屯区","南屯区","太平区","大里区","雾峰区","乌日区","丰原区","后里区","潭子区","大雅区","神冈区","石冈区","东势区","新社区","和平区"],
            ["台南市","中西区","东区","南区","北区","安平区","安南区","永康区","归仁区","新化区","左镇区","玉井区","楠西区","南化区","仁德区","关庙区","龙崎区"],
...
export function getCities(provinceName) {
  ...
  if (!p) return []
  return p.slice(1).map((c) => c[0])
}

export function getDistricts(provinceName, cityName) {
  const p = chinaRegions.find((p) => p[0] === provinceName)
  if (!p) return []
  const c = p.slice(1).find((c) => c[0] === cityName)
  if (!c) return []
  return c.slice(1)
}
