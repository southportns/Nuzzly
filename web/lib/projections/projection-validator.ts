...
const driftScore = this.calculateDriftScore(totalEvents?? 0,
...
private async findMissingEvents(def: { name: string; eventTypes: string[] },
...
private calculateDriftScore(totalEvents: number,
