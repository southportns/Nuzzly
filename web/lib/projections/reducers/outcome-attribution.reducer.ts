...
export const outcomeAttributionReducer: ProjectionReducer<OutcomeAttributionProjection> = (state: OutcomeAttributionProjection | undefined,
event: ProjectionEvent): OutcomeAttributionProjection => {
...
return {...s,
chains: [...s.chains,...chains],
aggregateScores: {...s.aggregateScores,
highConfidenceChains:
s.aggregateScores.highConfidenceChains +
chains.filter(c => c.confidence >= 0.8).length,
},
