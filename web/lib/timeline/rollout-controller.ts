 ...
 */
 ...
 return this.makeDecision("blend",
 ...
 return Math.round(timelineScore * decision.timelineWeight + reviewScore * decision.reviewWeight)
 default:
 return reviewScore
 }
 }
 ...
 */
 ...
 private makeDecision(engine: ScoringEngine,
 timelineWeight: number,
 reviewWeight: number,
 abGroup: "control" | "treatment" | null,
 decisionPath: DecisionPath,
 identityKey: string | null,
 hashSource: RolloutDecision["hashSource"]): RolloutDecision {
 ...
 rolloutPercentage: Math.round(timelineWeight + reviewWeight > 0? (timelineWeight / (timelineWeight + reviewWeight)) * 100: 0),
 },
 }
 }
