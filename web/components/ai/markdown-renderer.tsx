// can复use Markdown 渲染component
// 抽自 ai-chat-new.tsx,保持样式a致
// use on AI Free Chat,Ingredient Analysis etc.场景 AI output 渲染
"use client"
...
// sanitize schema: 扩展 img 属性 支持 Fluent Emoji
...
// Customcomponent样式: and Free Chat保持a致
...
// Custom img:确保 rehypeFluentEmoji 替换 emoji Images正确显示
