...
mv.setAttribute("alt", "Town mascot Pomi")
...
<div
className={cn("absolute rounded-full bg-gradient-to-br from-[#FFB89A]/30 via-[#FFD4C4]/20 to-transparent blur-2xl",
...
{/* Shadow on ground */}
<div
className={cn("absolute bottom-0 rounded-full bg-[#8B5E46]/10 blur-md",
