...
const navItems: { id: AIMode; label: string; icon: React.ReactNode; description: string }[] = [
{ id: "chat", label: t("freeChat"), icon: (<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 18 18">
...
</svg>), description: t("freeChatDesc") },
{ id: "recommend", label: t("smartRecommendations"), icon: (<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
...
</svg>), description: t("smartRecommendationsDesc") },
{ id: "ingredients", label: t("ingredientAnalysis"), icon: (<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 18 18">
...
</svg>), description: t("ingredientAnalysisDesc") },
{ id: "compare", label: t("productComparison"), icon: (<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
...
</svg>), description: t("productComparisonDesc") },
]

return (<aside className="flex w-64 shrink-0 flex-col h-full border-r border-[rgba(0,0,0,0.05)] bg-white/60 backdrop-blur-xl rounded-l-3xl overflow-hidden">
{/* Brand Header */}
<div className="flex flex-col items-center px-5 pt-6 pb-4">
<h1 className="text-[17px] font-bold tracking-tight text-[#111111]">
Pomi AI
</h1>
<p className="text-[11px] text-[#6B6B6B] tracking-wide">{t("pomiSmartPet")}</p>
...
<span className="text-[10px] font-medium text-[#5A8A52]">{t("onlineForYou")}</span>
</div>
</div>
...
className={cn("group relative flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left transition-all duration-200",
isActive? "bg-gradient-to-r from-[#FFB89A]/18 to-[#FF7A59]/10 text-[#111111] shadow-[inset_0_0_0_1px_rgba(255,122,89,0.15)]": "text-[#555555] hover:bg-[#F7F6F3] hover:text-[#111111]")}
>
{/* Active indicator bar */}
{isActive && (<span className="absolute left-0 top-1/2 -translate-y-1/2 h-5 w-[3px] rounded-r-full bg-gradient-to-b from-[#FFB89A] to-[#FF7A59]" />)}
<div
className={cn("flex size-8 shrink-0 items-center justify-center rounded-lg transition-colors",
isActive? "bg-gradient-to-br from-[#FFB89A] to-[#FF7A59] text-white shadow-[0_2px_8px_rgba(255,122,89,0.25)]": "bg-[#F0EFED] text-[#6B6B6B] group-hover:bg-[#E5E4E2]")}
>
{item.icon}
</div>
<div className="min-w-0 flex-1">
<div className="text-[13.5px] font-semibold leading-tight">{item.label}</div>
<div className={cn("text-[10.5px] leading-tight mt-0.5 transition-colors",
...
<div>
<p className="text-[11px] font-bold text-[#8B5E46]">Pomi AI</p>
