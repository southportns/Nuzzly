...
const navItems = [
  { href: "/dashboard", label: "我的概览", icon: () => (
  ...
  { href: "/dashboard/pets", label: "我的宠物", icon: () => (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 18 18">
  ...
  { href: "/dashboard/followups", label: "长期追踪", icon: () => (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 18 18">
  ...
  { href: "/dashboard/health", label: "健康管理", icon: () => (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 18 18">
  ...
  { href: "/dashboard/bookmarks", label: "我的收藏", icon: () => (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 18 18">
  ...
  { href: "/dashboard/recommendations", label: "推荐反馈", icon: () => (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 18 18">
  ...
  { href: "/dashboard/settings", label: "账号设置", icon: () => (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 18 18">
      ...
      <div className="overflow-hidden rounded-[20px] border border-[rgba(0,0,0,0.05)] bg-white">
        ...
        <div className="px-5 pb-4 pt-2">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2 text-[11px] text-[#6B6B6B]">
            <span>评价: {profile?.review_count ?? 0}</span>
            <span>追踪: {profile?.long_term_review_count ?? 0}</span>
            <span>验证: {profile?.verified_purchase_count ?? 0}</span>
            <span>行为: {profile?.behavior_score ?? 100}</span>
          </div>
        </div>
      </div>
