...
return (<div className="relative" onMouseEnter={handleEnter} onMouseLeave={handleLeave}>
<Link
href="/dashboard"
...
title={tDashboard("goToDashboard")}
>
<span>{tDashboard("go")}</span>
<span
...
<span className="text-[13.5px] font-semibold text-[#111111]">{t("dashboard")}</span>
</Link>
...
{signingOut? (<EmojiIcon name="Loader2" className="size-4 animate-spin" />): (<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 18 18" className="size-4">
...
<span className="text-[13.5px] font-semibold text-[#111111]">{t("signOut")}</span>
</button>
</div>
</div>
</div>)
