...
{Array.from({ length: 5 }).map((_, i) => (<EmojiIcon
key={i}
name="Star"
size={14}
...
<span className="text-[11px] text-[#6B6B6B]">{t("palatability")}</span>
<span className="text-[15px] font-semibold text-[#111111]">{p.palatability}</span>
</div>
<div className="flex flex-col items-center gap-0.5">
<span className="text-[11px] text-[#6B6B6B]">{t("softStoolRate")}</span>
<span className="text-[15px] font-semibold text-[#111111]">{p.stoolRate}</span>
</div>
<div className="flex flex-col items-center gap-0.5">
<span className="text-[11px] text-[#6B6B6B]">{t("repurchaseRate")}</span>
