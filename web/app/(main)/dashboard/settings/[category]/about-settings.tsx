  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-[14px] text-[#6B6B6B]">Learn about Nuzzly Town</p>
      </div>

      <SettingsCard className="p-6 text-center">
        <div className="mb-2 text-[48px]">🐾</div>
        <div className="text-[18px] font-semibold text-[#111111]">Nuzzly Town</div>
        <div className="mt-1 text-[13px] text-[#6B6B6B]">Version 1.0.0</div>
      </SettingsCard>

      <SettingsCard>
        <div className="divide-y divide-[rgba(0,0,0,0.04)]">
          {["User Agreement", "Privacy Policy", "Open Source License"].map((item) => (
            <div
              key={item}
