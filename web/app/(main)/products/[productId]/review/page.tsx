...
return (<div className="mx-auto max-w-lg px-6 py-8">
<div className="mb-6">
<div className="flex items-center gap-2 mb-2">
<EmojiIcon name="ShieldCheck" className="size-5 text-primary" />
<span className="text-sm text-muted-foreground">Structured authenticFeedback</span>
</div>
<h1 className="text-2xl font-bold">ReviewProduct</h1>
