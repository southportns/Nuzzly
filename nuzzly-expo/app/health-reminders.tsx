...
export default function HealthRemindersScreen() {
  ...
  async function handleDelete(r: HealthReminder) {
    Alert.alert('删除提醒', `确定删除"${r.title}"吗？`, [
        ...
        <View style={styles.remindersList}>
          {loading ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyTitle}>暂无健康提醒</Text>
              <Text style={styles.emptyDesc}>点击右下角 + 添加提醒</Text>
            </View>
          ) : (
              ...
              >
                ...
                <View style={styles.reminderBody}>
                  ...
                  <View style={styles.reminderMeta}>
                    ...
                    {r.repeat_interval && r.repeat_interval !== 'none' ? (
                  ...
                  >
                    {isOverdue(r) && !r.is_completed ? '已过期 · ' : ''}
