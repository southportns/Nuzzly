...
export default function AllergiesScreen() {
  ...
  function handleDelete(allergy: Allergy) {
    Alert.alert('删除过敏原', `确定删除"${allergy.allergen}"吗？`, [
  ...
  return (
    <View style={[styles.shell, { paddingTop: insets.top }]}>
      <PageHeader title="过敏管理" actionText="添加" onAction={() => setShowSheet(true)} />
      ...
      <BottomSheet visible={showSheet} onClose={() => setShowSheet(false)} title="添加过敏原" footer={sheetFooter}>
        <View style={styles.formGroup}>
          <Text style={styles.formLabel}>过敏原名称</Text>
          <TextInput
            value={newAllergen}
        ...
        <View style={styles.formGroup}>
          <View style={styles.toggleRow}>
            <Text style={styles.formLabel}>确认状态</Text>
            <TouchableOpacity
              activeOpacity={0.8}
