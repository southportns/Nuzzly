...
const TYPE_OPTIONS = [{ value: 'vaccination', label: 'Vaccine', icon: '💉' },
 { value: 'medication', label: 'Medication', icon: '💊' },
 { value: 'checkup', label: 'Check-up', icon: '🩺' },
 { value: 'custom', label: 'Custom', icon: '📌' },];

const REPEAT_OPTIONS = [{ value: 'none', label: 'Not ' },
...
export default function HealthReminderCreateScreen() {
 ...
 Alert.alert('CreateFailed', e.message || 'Please try again later');
 } finally {
 setSubmitting(false);
 }
 }
 ...
 <Text style={styles.cardTitle}>Create NewReminder</Text>
 ...
 <View style={styles.field}>
 <Text style={styles.fieldLabel}>to termDate</Text>
 <TextIn
 value={dueDate}
 ...
 >
 <Text style={styles.submitBtnText}>{submitting? 'CreateMedium...': 'CreateReminder'}</Text>
 </TouchableOpacity>
 </View>
 </ScrollView>
 </View>);
...
const styles = StyleSheet.create({
 ...
 borderWidth: 1,
 borderColor: 'rgba(255,255,255,0.6)',...shadows.xl,
