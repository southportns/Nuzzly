...
import { useComationJobs, ComationJob } from '../src/hooks/useComationJobs';
...
export default function JobsScreen() {
 ...
 const renderJob = (job: ComationJob) => {
 ...
 {job.error_message? (<Text style={styles.jobError} numberOfLines={2}>
 {job.error_message}
 </Text>): null}
 </View>
 </View>);
 ...
 >
 {!loading && jobs.length === 0? (<EmptyState icon="⚙️" title="NoneTask " />): (<View style={styles.jobList}>{jobs.map(renderJob)}</View>)}
 </ScrollView>
 </View>);
}
