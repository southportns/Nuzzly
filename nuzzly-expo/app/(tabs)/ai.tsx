...
export default function AIHubScreen() {
  ...
  const userAvatar = profile?.avatar_url || require('../../assets/images/pomi.png');
  ...
  const renderHeader = () => (
    <View style={styles.header}>
      <View style={styles.avatar}>
        <Image source={require('../../assets/images/pomi.png')} style={styles.avatarImg} />
      </View>
      ...
      <View style={[styles.card, styles.chatCard]}>
        <View style={styles.chatWelcome}>
          <View style={styles.chatWelcomeIcon}>
            <Image source={require('../../assets/images/pomi.png')} style={styles.chatWelcomeIconImg} />
          </View>
        ...
        >
          {chatMessages.length === 0 ? (
            <View style={styles.chatFsEmpty}>
              <Image source={require('../../assets/images/pomi.png')} style={styles.chatFsEmptyAvatar} />
              <Text style={styles.chatFsEmptyTitle}>你好，我是 Pomi</Text>
            ...
            chatMessages.map((m, i) => (
              <View key={i} style={[styles.chatRow, m.role === 'user' && styles.chatRowUser]}>
                {m.role === 'assistant' && <Image source={require('../../assets/images/pomi.png')} style={[styles.chatAvatar, styles.chatAvatarAi]} />}
                <View style={[styles.chatBubble, m.role === 'assistant' ? styles.chatBubbleAssistant : styles.chatBubbleUser]}>
                  {m.role === 'assistant' && !m.content && chatLoading ? (
                    <View style={styles.thinkingIndicator}>
                      ...
                      <Text style={styles.thinkingText}>Pomi 正在思考中</Text>
