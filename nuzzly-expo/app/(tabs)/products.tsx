...
export default function ProductsScreen() {
 ...
 setCategoryList([{ name: 'All', slug: '' }, ...categories]);
 ...
 <Text style={styles.cardScore}>Transparency {p.transparency_score}</Text>
 ) : null}
 </View>
 </View>
 </TouchableOpacity>
 ...
 <Text style={styles.subtitle}>Focused on cat products, powered by real long-term feedback data</Text>
 </View>
 <TouchableOpacity
 ...
 placeholder="Search cat food, brands, ingredients..."
 ...
 />
 <Text style={[styles.hotToggleText, hotOnly && styles.hotToggleTextActive]}>Hot Products</Text>
 </TouchableOpacity>
 ...
 <EmptyState icon="📦" title="No matching products" description="Try other keywords or categories" />
 )}
 </ScrollView>
 );
}
