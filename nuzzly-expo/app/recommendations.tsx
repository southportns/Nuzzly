            ...
            {recommendations.map((rec, idx) => (
              <View key={rec.id || idx} style={styles.recCard}>
                ...
                <View style={styles.recInfo}>
                  <Text style={styles.recName}>{rec.products?.name || '产品'}</Text>
                  <Text style={styles.recBrand}>{rec.products?.brand}</Text>
                  <Text style={styles.recScore}>匹配度: {rec.score ?? '-'}</Text>
                </View>
                {rec.products?.price_max != null ? (
                  <Text style={styles.recPrice}>¥{rec.products.price_max}</Text>
                ) : null}
              </View>
            ))}
          </View>
