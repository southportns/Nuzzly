...
const BUILTIN_TEMPLATES: Record<string, Partial<DailyTask>[]> = {
  cat: [
    { title: '早晨喂食', icon: '🍽', frequency: 'daily', weight: 20, reminder_time: '08:00' },
    { title: '晚上喂食', icon: '🍽', frequency: 'daily', weight: 20, reminder_time: '19:00' },
    { title: '换水', icon: '💧', frequency: 'daily', weight: 15, reminder_time: '09:00' },
    { title: '铲屎', icon: '🧹', frequency: 'daily', weight: 15, reminder_time: '20:00' },
    { title: '食盆清洁', icon: '🧼', frequency: 'weekly', weight: 10, reminder_time: '10:00' },
    { title: '驱虫', icon: '💊', frequency: 'monthly', weight: 10 },
    { title: '梳毛', icon: '✂', frequency: 'weekly', weight: 10 },
  ],
  dog: [
    { title: '早晨喂食', icon: '🍽', frequency: 'daily', weight: 20, reminder_time: '08:00' },
    { title: '晚上喂食', icon: '🍽', frequency: 'daily', weight: 20, reminder_time: '19:00' },
    { title: '换水', icon: '💧', frequency: 'daily', weight: 10, reminder_time: '09:00' },
    { title: '早晨遛狗', icon: '🦮', frequency: 'daily', weight: 15, reminder_time: '07:30' },
    { title: '晚上遛狗', icon: '🦮', frequency: 'daily', weight: 15, reminder_time: '19:00' },
    { title: '食盆清洁', icon: '🧼', frequency: 'weekly', weight: 10, reminder_time: '10:00' },
    { title: '驱虫', icon: '💊', frequency: 'monthly', weight: 10 },
  ],
  other: [
...
export function useDailyTasks(petId?: string) {
  ...
  const toggleTask = useCallback(async (taskId: string, currentlyCompleted: boolean, pid?: string) => {
    ...
    if (!targetPetId) throw new Error('缺少宠物ID');
